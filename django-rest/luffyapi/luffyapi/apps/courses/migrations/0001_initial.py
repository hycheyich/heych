# Generated by Django 2.2 on 2019-12-24 12:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_video', models.FileField(blank=True, max_length=255, null=True, upload_to='course_video', verbose_name='封面视频')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='发布日期')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='courses.Course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '课程章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_link', models.CharField(blank=True, help_text='若是video，填vid,若是文档，填link', max_length=255, null=True, verbose_name='课时链接')),
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='courses.CourseChapter', verbose_name='章节')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_list', to='courses.Course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '课程课时',
