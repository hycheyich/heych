# -*- coding: utf-8 -*-
# Generated by Django 1.11.25 on 2019-11-19 12:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Department')),
            ],
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='confirm_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='confirms', to='app01.UserProfile', verbose_name='确认人'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.UserProfile', verbose_name='销售'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='customer',
        ...
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='app01.UserProfile', verbose_name='销售'),
        ),
        migrations.AddField(
            model_name='customer',
            name='introduce_from',
        ...
        migrations.AddField(
            ...
            name='recorder',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='CourseRecord', to='app01.UserProfile', verbose_name='记录者'),
        ),
        migrations.AddField(
            model_name='courserecord',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Course_Record', to='app01.UserProfile', verbose_name='讲师'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records', to='app01.UserProfile', verbose_name='跟进人'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
        ...
        migrations.AddField(
            ...
            name='teachers',
            field=models.ManyToManyField(to='app01.UserProfile', verbose_name='老师'),
        ),
