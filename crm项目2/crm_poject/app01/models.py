...
class Customer(models.Model):
    ...
    def show_color_statuc(self):
        ...
        return '<span style="background-color: {};padding: 6px">{}</span>'.format(color_dic[self.status],
...
class Enrollment(models.Model):
    ...
    school = models.ForeignKey('Campuses',verbose_name='学校')
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey('UserProfile', verbose_name="讲师", related_name='Course_Record')
    recorder = models.ForeignKey('UserProfile', verbose_name="记录者", related_name='CourseRecord')
