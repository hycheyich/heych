...
class Pagination:
    def __init__(self, page, count_data, params, per_num=10, max_show=11):
        """
        :param page: 页码
    ...
    def page_html(self):
        ...
        for i in range(page_start, page_end + 1):
            if i == self.page:
                self.params['page'] = i
                page_html_lis.append('<li class="active"><a href="?{}">{}</a></li>'.format(self.params.urlencode(), i))
            else:
                self.params['page'] = i
                page_html_lis.append('<li><a href="?{}">{}</a></li>'.format(self.params.urlencode(), i))
